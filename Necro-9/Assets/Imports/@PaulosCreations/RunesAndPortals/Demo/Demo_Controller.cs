...
public class Demo_Controller : MonoBehaviour
{
    ...
    [SerializeField] private Portal_Controller portalSimpleScripts;  // Este es el PortalGates_Simple
    ...
    private void Start()
    {
        ...
        // Asegurarse de que el portal simple (PortalGates_Simple) esté siempre encendido
    ...
    private IEnumerator DemoRoutine()
    {
        ...
        // No es necesario activar portalSimpleScripts.TogglePortal(true) aquí, ya está en Start()
        ...
        yield return new WaitForSeconds(7f);
        // No desactivar el portalSimpleScripts.TogglePortal(false), ya se mantiene encendido
